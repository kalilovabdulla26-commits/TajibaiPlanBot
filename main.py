...
# GitHub'дагы файлдын аты баш тамга менен Arial.ttf болушу шарт
FONT_PATH = "Arial.ttf" 
...
async def handle_name(m: types.Message):
    ...
    if uid in user_states:
        ...
        for admin in ADMIN_IDS:
            try: await bot.send_photo(admin, photo=user_states[uid]['photo'], caption=f"📩 Жаңы: {name}", reply_markup=builder.as_markup())
            except: pass
